...
def homebridge_switch_on():
    ...
    print "GET /device/holiday/homebridge/switch/on"
    status = app.licht.get_led_value(0)

    if app.light_status == 1:
        return "1\n"

    app.light_status = 1
    set_light_values(app.homebridge_last_rgb)
    return "1\n"

@app.get('/device/holiday/homebridge/switch/off')
def homebridge_switch_off():

    print "GET /device/holiday/homebridge/switch/off"

    if app.light_status == 0:
        return "1\n"
...
def homebridge_switch_status():
    print "GET /device/holiday/homebridge/switch/statusf"
